...
import { Heart, Activity, Apple, Moon, Droplet, Brain, Thermometer, Shield, Download, Stethoscope, Baby, Bandage, Syringe, Pill, Eye } from "lucide-react";
...
const BasicHealthGuide = () => {
  ...
  const generatePDF = () => {
    toast({
      title: t.downloadPdf,
      description: "Preparing your health guide...",
    });

    const content = `MEDISOUL - BASIC HEALTH GUIDE
=====================================
...
• Take acetaminophen (500mg every 4-6 hours) or ibuprofen
...
• Signs of good hydration: light yellow urine

MENTAL HEALTH
• Practice mindfulness or meditation (10-15 minutes daily)
• Exercise regularly, maintain sleep schedule
• Seek professional help if experiencing persistent sadness
...
=====================================
${t.disclaimer}
Source: Drugs.com, NHS.uk, WHO Guidelines
Generated by MediSoul - ${new Date().toLocaleDateString()}
`;
    ...
    link.href = url;
    link.download = `MediSoul-Health-Guide-${language.toUpperCase()}.txt`;
    ...
    toast({
      title: "Downloaded!",
      description: "Health guide saved to your device.",
    });
  };
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="glass rounded-3xl p-8 mb-8">
            ...
            <Accordion type="single" collapsible className="space-y-4">
              ...
              <AccordionItem value="diabetes" className="glass rounded-xl px-6">
                <AccordionTrigger className="hover:no-underline">
                  <div className="flex items-center gap-3">
                    <Droplet className="h-5 w-5 text-primary" />
                    <span>Diabetes & Blood Sugar</span>
                  </div>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground">
                  <div className="space-y-3 mt-4">
                    <p className="font-semibold text-foreground">Healthy blood sugar targets (general):</p>
                    <ul className="space-y-1">
                      <li>• Fasting: 70–99 mg/dL (3.9–5.5 mmol/L)</li>
                      <li>• 2 hours after meals: under 140 mg/dL (7.8 mmol/L)</li>
                      <li>• HbA1c (3-month average): under 5.7% normal, 5.7–6.4% prediabetes</li>
                    </ul>
                    <p className="font-semibold text-foreground mt-4">Daily habits that help:</p>
                    <ul className="space-y-1">
                      <li>• Eat fiber-rich vegetables, whole grains, legumes</li>
                      <li>• Limit sugary drinks, refined carbs, deep-fried foods</li>
                      <li>• Walk 10–15 minutes after each main meal</li>
                      <li>• Sleep 7–9 hours and manage stress</li>
                      <li>• Check blood sugar as advised by your doctor</li>
                    </ul>
                    <p className="font-semibold text-red-500 mt-4">Warning signs to act on:</p>
                    <ul className="space-y-1">
                      <li>• Excessive thirst, frequent urination, unexplained weight loss</li>
                      <li>• Blurred vision, slow-healing wounds, persistent fatigue</li>
                      <li>• Sweet/fruity breath, confusion (possible emergency)</li>
                    </ul>
                  </div>
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="bp" className="glass rounded-xl px-6">
                <AccordionTrigger className="hover:no-underline">
                  <div className="flex items-center gap-3">
                    <Heart className="h-5 w-5 text-red-500" />
                    <span>Blood Pressure & Cholesterol</span>
                  </div>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground">
                  <div className="space-y-3 mt-4">
                    <p className="font-semibold text-foreground">Blood pressure categories (mmHg):</p>
                    <ul className="space-y-1">
                      <li>• Normal: under 120/80</li>
                      <li>• Elevated: 120–129/under 80</li>
                      <li>• Stage 1 hypertension: 130–139/80–89</li>
                      <li>• Stage 2 hypertension: 140+/90+</li>
                      <li>• Hypertensive crisis: 180+/120+ — seek emergency care</li>
                    </ul>
                    <p className="font-semibold text-foreground mt-4">DASH-style eating to lower BP:</p>
                    <ul className="space-y-1">
                      <li>• Vegetables, fruits, low-fat dairy, whole grains, lean protein</li>
                      <li>• Sodium under 2,300 mg/day (ideally 1,500 mg)</li>
                      <li>• Potassium-rich foods: bananas, spinach, sweet potatoes</li>
                      <li>• Limit alcohol; avoid tobacco</li>
                    </ul>
                    <p className="font-semibold text-foreground mt-4">Cholesterol targets (general adults):</p>
                    <ul className="space-y-1">
                      <li>• Total: under 200 mg/dL</li>
                      <li>• LDL ("bad"): under 100 mg/dL</li>
                      <li>• HDL ("good"): 60+ mg/dL is protective</li>
                      <li>• Triglycerides: under 150 mg/dL</li>
                    </ul>
                  </div>
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="women" className="glass rounded-xl px-6">
                <AccordionTrigger className="hover:no-underline">
                  <div className="flex items-center gap-3">
                ...
                <AccordionContent className="text-muted-foreground">
                  <div className="space-y-3 mt-4">
                    <p className="font-semibold text-foreground">Key screenings:</p>
                    <ul className="space-y-1">
                      <li>• Cervical cancer (Pap/HPV): every 3–5 years from age 21–25</li>
                      <li>• Breast self-exam monthly; mammogram from age 40–50 as advised</li>
                      <li>• Iron, calcium, and vitamin D levels — especially during/after pregnancy</li>
                      <li>• Bone density (DEXA) from age 65 or earlier if at risk</li>
                    </ul>
                    <p className="font-semibold text-foreground mt-4">Menstrual & reproductive health:</p>
                    <ul className="space-y-1">
                      <li>• Track cycle length, flow, and pain — flag sudden changes</li>
                      <li>• Severe pain, very heavy bleeding, or missed periods → consult a doctor</li>
                      <li>• Folic acid 400 mcg daily if planning pregnancy</li>
                    </ul>
                    <p className="font-semibold text-foreground mt-4">Menopause support:</p>
                    <ul className="space-y-1">
                      <li>• Strength training and weight-bearing exercise to protect bones</li>
                      <li>• Discuss hot-flash management and HRT options with your doctor</li>
                    </ul>
                  </div>
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="children" className="glass rounded-xl px-6">
                <AccordionTrigger className="hover:no-underline">
                  <div className="flex items-center gap-3">
                    <Baby className="h-5 w-5 text-accent" />
                    <span>Child & Infant Health</span>
                  </div>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground">
                  <div className="space-y-3 mt-4">
                    <p className="font-semibold text-foreground">Developmental milestones (general):</p>
                    <ul className="space-y-1">
                      <li>• 2 months: smiles, follows objects with eyes</li>
                      <li>• 6 months: rolls over, babbles, sits with support</li>
                      <li>• 12 months: stands, says first words, finger-feeds</li>
                      <li>• 2 years: 50+ words, runs, climbs</li>
                    </ul>
                    <p className="font-semibold text-foreground mt-4">When to call a pediatrician:</p>
                    <ul className="space-y-1">
                      <li>• Fever &gt; 100.4°F (38°C) in infants under 3 months</li>
                      <li>• Refusing feeds, unusual lethargy, or persistent crying</li>
                      <li>• Rash with fever, breathing difficulty, dehydration signs</li>
                      <li>• Missed vaccinations or sudden loss of acquired skills</li>
                    </ul>
                    <p className="font-semibold text-foreground mt-4">Daily essentials:</p>
                    <ul className="space-y-1">
                      <li>• Exclusive breastfeeding for first 6 months when possible</li>
                      <li>• Balanced meals, limited screen time, 9–14 hours sleep</li>
                      <li>• Encourage outdoor play and reading time</li>
                    </ul>
                  </div>
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="firstaid" className="glass rounded-xl px-6">
                <AccordionTrigger className="hover:no-underline">
                  <div className="flex items-center gap-3">
                ...
                <AccordionContent className="text-muted-foreground">
                  <div className="space-y-3 mt-4">
                    <p className="font-semibold text-foreground">Cuts & wounds:</p>
                    <ul className="space-y-1">
                      <li>• Apply firm pressure with clean cloth for 5–10 minutes</li>
                      <li>• Rinse with clean water, apply antiseptic, cover with sterile bandage</li>
                      <li>• Seek care if wound is deep, gaping, dirty, or won't stop bleeding</li>
                    </ul>
                    <p className="font-semibold text-foreground mt-4">Burns:</p>
                    <ul className="space-y-1">
                      <li>• Cool under running water for 20 minutes — do NOT use ice or butter</li>
                      <li>• Cover loosely with clean cloth or cling film</li>
                      <li>• Hospital for burns larger than a palm, on face/hands/genitals, or with blisters</li>
                    </ul>
                    <p className="font-semibold text-foreground mt-4">Choking (adult):</p>
                    <ul className="space-y-1">
                      <li>• Encourage coughing if they can</li>
                      <li>• 5 back blows between shoulder blades, then 5 abdominal thrusts (Heimlich)</li>
                      <li>• Repeat until object is dislodged or call emergency services</li>
                    </ul>
                    <p className="font-semibold text-foreground mt-4">Sprains (R.I.C.E.):</p>
                    <ul className="space-y-1">
                      <li>• Rest, Ice (15–20 min), Compression bandage, Elevation above heart</li>
                    </ul>
                  </div>
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="vaccines" className="glass rounded-xl px-6">
                <AccordionTrigger className="hover:no-underline">
                  <div className="flex items-center gap-3">
                ...
                <AccordionContent className="text-muted-foreground">
                  <div className="space-y-3 mt-4">
                    <p className="font-semibold text-foreground">Childhood (WHO/CDC overview):</p>
                    <ul className="space-y-1">
                      <li>• Birth: BCG, Hepatitis B, OPV-0</li>
                      <li>• 6, 10, 14 weeks: DPT, Hib, Hepatitis B, IPV, Rotavirus, PCV</li>
                      <li>• 9 months: Measles/MMR, Vitamin A</li>
                      <li>• 15–18 months: MMR booster, DPT booster</li>
                      <li>• 5 years: DPT booster; 10–12 years: HPV (girls & boys)</li>
                    </ul>
                    <p className="font-semibold text-foreground mt-4">Adults:</p>
                    <ul className="space-y-1">
                      <li>• Tetanus booster every 10 years</li>
                      <li>• Annual flu shot (especially 60+, pregnant, chronic conditions)</li>
                      <li>• COVID-19 boosters as recommended locally</li>
                      <li>• Pneumococcal & shingles vaccines from age 50–65</li>
                    </ul>
                  </div>
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="medication" className="glass rounded-xl px-6">
                <AccordionTrigger className="hover:no-underline">
                  <div className="flex items-center gap-3">
                    <Pill className="h-5 w-5 text-accent" />
                    <span>Safe Medication Use</span>
                  </div>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground">
                  <div className="space-y-3 mt-4">
                    <ul className="space-y-2">
                      <li>• Take medicines exactly as prescribed — don't skip or double doses</li>
                      <li>• Read labels for active ingredients to avoid duplication (e.g., paracetamol in cold meds)</li>
                      <li>• Never share antibiotics; always finish the full course</li>
                      <li>• Store in cool, dry, child-safe place; check expiry dates</li>
                      <li>• Tell your doctor about every supplement, herb, and OTC drug you take</li>
                      <li>• Use MediSoul's Image Analysis (Medicine mode) to scan packaging for usage info</li>
                    </ul>
                  </div>
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="eyes" className="glass rounded-xl px-6">
                <AccordionTrigger className="hover:no-underline">
                  <div className="flex items-center gap-3">
                    <Eye className="h-5 w-5 text-secondary" />
                    <span>Eye & Screen Health</span>
                  </div>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground">
                  <div className="space-y-3 mt-4">
                    <ul className="space-y-2">
                      ...
                      <li>• Position screen an arm's length away, slightly below eye level</li>
                      <li>• Blink often; use lubricating drops for dryness</li>
                      <li>• Annual eye check from age 40, sooner if you have diabetes/BP</li>
                      <li>• Wear UV-protection sunglasses outdoors</li>
                    </ul>
                  </div>
                </AccordionContent>
              </AccordionItem>
